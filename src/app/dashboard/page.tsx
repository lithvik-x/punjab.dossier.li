      ...
      <Card hover>
        ...
        <CardContent>
          ...
          <DataTable
            ...
            rows={[
              [<span key="s1" className="font-medium">Jat Sikh</span>, "General", "21%", "28,500", <Badge key="b1" variant="success" size="sm">Medium-High</Badge>],
              [<span key="s2" className="font-medium">Mazhabi Sikh</span>, "SC", "8%", "10,900", <Badge key="b2" variant="success" size="sm">High</Badge>],
              [<span key="s3" className="font-medium">Bania</span>, "General", "7%", "9,500", <Badge key="b3" variant="success" size="sm">Medium-High</Badge>],
              [<span key="s4" className="font-medium">Ramdasia</span>, "SC", "5%", "6,800", <Badge key="b4" variant="success" size="sm">High</Badge>],
              [<span key="s5" className="font-medium">Brahmin</span>, "General", "4%", "5,400", <Badge key="b5" variant="default" size="sm">Medium</Badge>],
              [<span key="s6" className="font-medium">Lodhgarh</span>, "OBC", "3%", "4,100", <Badge key="b6" variant="default" size="sm">Medium</Badge>],
              [<span key="s7" className="font-medium">Arora</span>, "General", "3%", "4,100", <Badge key="b7" variant="success" size="sm">High</Badge>],
              [<span key="s8" className="font-medium">Tarkhan</span>, "OBC/SC", "3%", "4,100", <Badge key="b8" variant="default" size="sm">Medium</Badge>],
            ]}
          />
        </CardContent>
      </Card>
