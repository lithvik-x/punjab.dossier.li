    ...
    <div className="space-y-8">
      ...
      <div className="rounded-xl border border-purple-200 bg-purple-50 p-6 shadow-sm dark:border-purple-800 dark:bg-purple-900/20">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-4">
          <MetricCard title="Diljit Dosanjh" value="26.7M" subtitle="Instagram followers" color="bg-purple-500" />
          <MetricCard title="Guru Randhawa" value="36.5M" subtitle="Instagram followers" color="bg-green-500" />
          <MetricCard title="Yo Yo Honey Singh" value="20.9M" subtitle="Instagram followers" color="bg-orange-500" />
          <MetricCard title="Sidhu Moosewala" value="28.5M" subtitle="YouTube (memorial)" color="bg-red-500" />
        </div>
        <DataTable
