    ...
    <div className="space-y-8">
      ...
      <div className="rounded-xl border border-orange-200 bg-orange-50 p-6 shadow-sm dark:border-orange-800 dark:bg-orange-900/20">
        <h3 className="text-lg font-semibold text-orange-700 dark:text-orange-300">
          Congress Media Coverage Assessment
        </h3>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
        <h3 className="text-lg font-semibold text-slate-900 dark:text-white">
          Party Coverage Volume Comparison
        </h3>
        <div className="mt-4 space-y-3">
          ...
          <div className="flex items-center gap-4 p-3 rounded-lg bg-orange-50 dark:bg-orange-900/20">
          ...
          <div className="flex items-center gap-4 p-3 rounded-lg bg-slate-50 dark:bg-slate-800">
