...
export default function CampaignStrategyPage() {
  return (
    <div className="space-y-8">
      {/* MP4-004: Campaign Narrative & Strategy */}
      <motion.div
          ...
          <CardContent>
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="rounded-lg bg-white p-4 shadow-sm dark:bg-slate-800">
                ...
                <p className="text-2xl font-bold text-rose-600 mt-1">&quot;Judega Block, Jittegi Congress&quot;</p>
            ...
            <h4 className="mt-6 font-semibold text-rose-900 dark:text-rose-100">Five Supporting Pillars</h4>
            <div className="mt-3 grid gap-3 md:grid-cols-5">
              ...
              <div className="rounded-lg bg-white p-3 dark:bg-slate-800">
                <span className="text-xs font-bold text-rose-600">#5</span>
            ...
            <h4 className="mt-6 font-semibold text-rose-900 dark:text-rose-100">Message Architecture</h4>
            <div className="mt-3 grid gap-3 md:grid-cols-3">
              <div className="rounded-lg bg-rose-100 p-3 dark:bg-rose-900/40">
                <p className="text-sm font-medium text-rose-700">&quot;Haath Uthao Punjab Banao&quot;</p>
                <p className="text-xs text-rose-600 mt-1">Uplift message</p>
              </div>
              <div className="rounded-lg bg-rose-100 p-3 dark:bg-rose-900/40">
                <p className="text-sm font-medium text-rose-700">&quot;4 Saal 0 Kaam&quot;</p>
                <p className="text-xs text-rose-600 mt-1">Attack line — 4 years, zero work</p>
              </div>
              <div className="rounded-lg bg-rose-100 p-3 dark:bg-rose-900/40">
                <p className="text-sm font-medium text-rose-700">&quot;AAP Ka Haath, Bagal Mein Duniya&quot;</p>
                <p className="text-xs text-rose-600 mt-1">AAP&apos;s hand, world in pocket (inaccessible)</p>
              </div>
            </div>
        ...
        <Card className="border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-900/20">
          ...
          <CardContent>
            <div className="mt-4 grid gap-4 md:grid-cols-4">
              ...
              <div className="rounded-lg bg-white p-4 shadow-sm dark:bg-slate-800">
                <div className="flex items-center gap-2">
                  <span className="flex h-8 w-8 items-center justify-center rounded-full bg-purple-500 text-xs font-bold text-white">2</span>
                  <span className="text-sm font-bold text-purple-600">INTENSIFICATION</span>
                </div>
              ...
              <div className="rounded-lg bg-white p-4 shadow-sm dark:bg-slate-800">
                <div className="flex items-center gap-2">
                  <span className="flex h-8 w-8 items-center justify-center rounded-full bg-rose-500 text-xs font-bold text-white">4</span>
                  <span className="text-sm font-bold text-rose-600">FINAL SPRINT</span>
                </div>
      ...
      {/* MP4-007: Caste Coalition Targets */}
      <motion.div
        initial={{ opacity: 0, y: 8 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        <Card className="border-purple-200 bg-purple-50 dark:border-purple-800 dark:bg-purple-900/20">
          ...
          <CardContent>
            <div className="mt-4 grid gap-4 md:grid-cols-5">
              <div className="rounded-lg bg-white p-4 shadow-sm dark:bg-slate-800">
                <p className="text-xs text-slate-500">SC (all sub-caste)</p>
      ...
      {/* MP6-003: Volunteer Recruitment & Training */}
      <motion.div
        initial={{ opacity: 0, y: 8 }}
        animate={{ opacity: 1, y: 0 }}
