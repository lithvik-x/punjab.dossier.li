...
export default function CampaignBudgetPage() {
  return (
    <div className="space-y-8">
      {/* MP4-025: Campaign Budget Estimate */}
      <motion.div
        ...
        <Card className="border-emerald-200 bg-emerald-50 dark:border-emerald-800 dark:bg-emerald-900/20">
          ...
          <CardContent>
            ...
            <div className="mt-3 grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-lg bg-white p-4 shadow-sm dark:bg-slate-800">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-amber-600">Swing (30-40 seats)</span>
              ...
              <div className="rounded-lg bg-white p-4 shadow-sm dark:bg-slate-800">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-emerald-600">Safe (60+ seats)</span>
            ...
            <div className="mt-3 grid gap-4 md:grid-cols-4">
              ...
              <div className="rounded-lg bg-white p-3 shadow-sm dark:bg-slate-800">
                ...
                <p className="text-lg font-bold text-rose-600">Rs 40 L</p>
            ...
            <div className="mt-6 grid gap-6 lg:grid-cols-2">
              ...
              <div className="rounded-lg bg-white p-4 shadow-sm dark:bg-slate-800">
                ...
                <div className="mt-3 space-y-3">
                  ...
                  <div className="flex items-center gap-3"><div className="flex h-8 w-8 items-center justify-center rounded-full bg-emerald-100 text-xs font-bold text-emerald-700">10-15%</div><div><p className="text-sm font-medium">Volunteer Vehicles</p><p className="text-xs text-slate-500">Fuel + maintenance reimbursement</p></div></div>
                </div>
              </div>
            </div>
