...
import { MessageSquare, Users, AlertTriangle, Lightbulb, Heart, Shield, Scale, Globe } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Message Architecture - Appeal Types</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        >
          <Card>
            <CardHeader>
              <CardTitle>Dera Networks - Political Influence</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-slate-500 mb-4">From a23-punjab-nri-political-influence-2026, b13-voter-psychology-influence-methodology</p>
        ...
        >
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-slate-500 mb-4">From b13-voter-psychology-influence-methodology</p>
              <div className="space-y-3">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Voter Value Clusters</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Issue Salience Hierarchy 2027</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
