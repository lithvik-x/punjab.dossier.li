...
export default function PartyDynamicsPage() {
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
        <h3 className="text-lg font-semibold text-slate-900 dark:text-white">
          2022 Assembly Election — Vote Share Summary
        </h3>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
        <h3 className="text-lg font-semibold text-slate-900 dark:text-white">
          Composite Voter Type Taxonomy
        </h3>
        <p className="text-sm text-slate-500">9-type voter classification for 2027 targeting</p>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-white">
            Congress Vote Share — Floor/Ceiling
          </h3>
          <p className="text-sm text-slate-500">Projected ranges for 2027</p>
          <div className="mt-4 space-y-3">
            <div className="flex items-center justify-between">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-white">
            AAP Seat Flip Margin Analysis
          </h3>
          <p className="text-sm text-slate-500">Swing required to flip AAP seats to Congress</p>
