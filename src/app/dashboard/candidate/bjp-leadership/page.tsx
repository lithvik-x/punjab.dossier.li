...
import { Volume2, Users, ArrowRight, Building, Target } from "lucide-react";
...
export default function BJPLeadershipPage() {
  return (
    <div className="space-y-8">
      ...
      >
        <Card className="border-2 border-orange-400 bg-orange-50 dark:border-orange-700 dark:bg-orange-900/20">
          <CardHeader>
            <CardTitle className="text-orange-700 dark:text-orange-400 flex items-center gap-2">
              <Volume2 className="h-5 w-5" />
              &quot;No More Chhota Bhai&quot; — Amit Shah, March 14, 2026
            </CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card className="border-2 border-orange-500 bg-orange-50 dark:border-orange-700 dark:bg-orange-900/20">
          <CardHeader>
