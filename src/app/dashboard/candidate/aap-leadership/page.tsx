...
// Assembly segment leads breakdown
...
// Vulnerable cabinet ministers (lost own segment leads in 2024 LS)
...
export default function AAPLeadershipPage() {
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-xl border-2 border-red-400 bg-red-50 p-5 dark:border-red-700 dark:bg-red-900/20">
        <div className="flex items-start gap-4">
          <span className="text-3xl">🚨</span>
          <div>
            <h3 className="text-lg font-bold text-red-700 dark:text-red-400">Crisis: 7 Rajya Sabha MPs Defected to BJP (April 24, 2026)</h3>
      ...
      {/* Core Leadership */}
      <div className="rounded-xl border border-cyan-200 bg-white p-6 shadow-sm dark:border-cyan-800 dark:bg-slate-800">
        <div className="flex items-center gap-3 mb-4">
          <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-cyan-500 text-sm font-bold text-white">CM</span>
          <div>
            <h3 className="text-lg font-semibold text-cyan-700 dark:text-cyan-400">Core Leadership Matrix</h3>
      ...
      <div className="rounded-xl border border-red-200 bg-white p-6 shadow-sm dark:border-red-800 dark:bg-slate-800">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-red-700 dark:text-red-400">Vulnerable Ministers & Anti-Incumbency Risk</h3>
      ...
      <div className="rounded-xl border border-amber-200 bg-white p-6 shadow-sm dark:border-amber-800 dark:bg-slate-800">
        <div className="flex items-center gap-3 mb-4">
          <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-sm font-bold text-white">↔</span>
          <div>
            <h3 className="text-lg font-semibold text-amber-700 dark:text-amber-400">AAP Turncoats & Defectors</h3>
      ...
      <div className="rounded-xl border-2 border-cyan-500 bg-cyan-50 p-6 dark:border-cyan-700 dark:bg-cyan-900/20">
        <div className="flex items-center gap-3 mb-4">
          <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-cyan-500 text-lg font-bold text-white">27</span>
          <div>
            <h3 className="text-lg font-semibold text-cyan-700 dark:text-cyan-400">2027 Punjab Election Outlook</h3>
            <p className="text-sm text-cyan-600 dark:text-cyan-400">AAP re-election prospects — Without Kejriwal tailwinds</p>
          </div>
        </div>

        <div className="grid gap-4 md:grid-cols-3">
          <MetricCard title="Seats at Risk (Base)" value="55-65" subtitle="If 2024 LS trends repeat" color="bg-red-500" />
          <MetricCard title="Safe Seats" value="25-30" subtitle="Mann popularity, incumbency apparatus" color="bg-cyan-500" />
          <MetricCard title="Hung Assembly Odds" value="70%" subtitle="4-way split: AAP-Cong-BJP-SAD" color="bg-purple-500" />
        </div>
