...
import { Badge, MiniChart } from "@/components/ui/MetricCard";
            ...
            <div className="mt-4 grid gap-6 md:grid-cols-3">
              <div className="rounded-lg bg-white p-4 dark:bg-slate-800">
                <div className="flex items-center justify-between">
                  ...
                  <MiniChart data={[12, 8, 5, 3, 2, 1]} color="emerald" height={50} />
                </div>
              ...
              <div className="rounded-lg bg-white p-4 dark:bg-slate-800">
                <div className="flex items-center justify-between">
                  ...
                  <MiniChart data={[70, 75, 78, 80, 82, 85]} color="blue" height={50} />
                </div>
              ...
              <div className="rounded-lg bg-white p-4 dark:bg-slate-800">
                <div className="flex items-center justify-between">
                  ...
                  <MiniChart data={[320, 380, 420, 460, 490, 520]} color="rose" height={50} />
                </div>
