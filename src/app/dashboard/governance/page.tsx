...
export default function GovernancePage() {
  ...
  return (
    <div className="space-y-6">
      {/* Page Header */}
      <div className="rounded-xl border-2 border-slate-200 bg-slate-50 p-6 dark:border-slate-700 dark:bg-slate-800/50">
        ...
        {sections.map((section) => {
          ...
          return (
            <Link
              key={section.id}
              href={section.href}
              className="group rounded-xl border border-slate-200 bg-white p-6 transition-all hover:border-slate-300 hover:shadow-lg dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600"
            >
