  ...
  return (
    <div className="space-y-8">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>ECI Readiness & Electoral Infrastructure</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle> EVM/VVPAT Infrastructure (2022 Election Data)</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-4">
              <MetricCard title="Ballot Units (BU)" value="45,316" subtitle="For 2022 election" color="emerald" />
              <MetricCard title="Control Units (CU)" value="34,942" subtitle="For 2022 election" color="blue" />
              <MetricCard title="VVPATs" value="37,576" subtitle="For 2022 election" color="purple" />
              <MetricCard title="EVMs per Booth" value="1 BU + 1 CU" subtitle="Standard configuration" color="cyan" />
            </div>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Model Code of Conduct (MCC) Enforcement</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <MetricCard title="Silence Period" value="48 Hours" subtitle="Before polling day" color="rose" />
              <MetricCard title="cVIGIL Response" value="100 Min" subtitle="Target resolution time" color="blue" />
              <MetricCard title="MCC Violations" value="2022 FIR" subtitle="CM Channi case" color="orange" />
              <MetricCard title="ECI Directives" value="Continuous" subtitle="From announcement" color="purple" />
            </div>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="rounded-lg bg-red-50 p-4 dark:bg-red-900/20">
                <p className="text-sm font-medium text-red-700 dark:text-red-400 flex items-center gap-2">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Election Schedule 2027</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              <MetricCard title="Election Type" value="Single-Phase" subtitle="117 constituencies" color="cyan" />
              <MetricCard title="Projected Month" value="February 2027" subtitle="Per ECI tradition" color="blue" />
              <MetricCard title="Announcement" value="Feb 2027" subtitle="ECI notification" color="purple" />
            </div>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="rounded-lg bg-sky-50 p-4 dark:bg-sky-900/20">
                <p className="text-sm font-medium text-sky-700 dark:text-sky-400 flex items-center gap-2">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Election Funding & Spending Limits</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              <MetricCard title="Spending Limit" value="Rs 40L" subtitle="Per candidate" color="emerald" />
              <MetricCard title="Total State Limit" value="Rs 46.8 Cr" subtitle="117 x Rs 40L" color="blue" />
              <MetricCard title="Electoral Bonds" value="Struck Down" subtitle="SC 2024 verdict" color="rose" />
            </div>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="rounded-lg bg-amber-50 p-4 dark:bg-amber-900/20">
                <p className="text-sm font-medium text-amber-700 dark:text-amber-400 flex items-center gap-2">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Election Crime & Criminalization of Politics</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <MetricCard title="Candidates w/Criminal Cases" value="25%" subtitle="ADR data" color="rose" />
              <MetricCard title="Winning MLAs w/Criminal" value="50%" subtitle="State legislature" color="orange" />
              <MetricCard title="Candidates Declared Guilty" value="315" subtitle="ADR tracked" color="purple" />
              <MetricCard title="Murder Cases" value="42" subtitle="Serious IPC charges" color="rose" />
            </div>
            <div className="mt-4">
              <DataTable
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Booth Capture & Repoll Data</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              <MetricCard title="Repolls (Dec 2025)" value="16" subtitle="By-election repolls" color="rose" />
              <MetricCard title="Rural Turnout" value="48%" subtitle="Booth-level (suspect)" color="orange" />
              <MetricCard title="Booth Agents Required" value="22,000+" subtitle="For 2027" color="blue" />
            </div>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="rounded-lg bg-red-50 p-4 dark:bg-red-900/20">
                <p className="text-sm font-medium text-red-700 dark:text-red-400 flex items-center gap-2">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Candidate Affidavits & Asset Analysis</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-4">
              <MetricCard title="Crorepati Candidates" value="67%" subtitle="Self-declared assets" color="emerald" />
              <MetricCard title="Avg Asset Value" value="Rs 1.2 Cr" subtitle="Per candidate" color="blue" />
              <MetricCard title="Graduate+ Candidates" value="74%" subtitle="Higher education" color="purple" />
              <MetricCard title="Criminal Cases" value="25%" subtitle="Serious IPC charges" color="rose" />
            </div>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="rounded-lg bg-blue-50 p-4 dark:bg-blue-900/20">
                <p className="text-sm font-medium text-blue-700 dark:text-blue-400 flex items-center gap-2">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Legal Framework & Anti-Defection</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <MetricCard title="Anti-Defection" value="10th Schedule" subtitle="Constitution" color="purple" />
              <MetricCard title="Defection Penalty" value="Disqualification" subtitle="+ Seat lost" color="rose" />
              <MetricCard title="Petition Window" value="45 Days" subtitle="Post-election" color="blue" />
              <MetricCard title="Bikram Majithia" value="Drug Case" subtitle="Ongoing trial" color="orange" />
            </div>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="rounded-lg bg-purple-50 p-4 dark:bg-purple-900/20">
                <p className="text-sm font-medium text-purple-700 dark:text-purple-400 flex items-center gap-2">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>2022 Assembly Election Results</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-4">
              <MetricCard title="AAP" value="92 seats" subtitle="42.01% vote share" color="purple" />
              <MetricCard title="Congress" value="18 seats" subtitle="22.98% vote share" color="orange" />
              <MetricCard title="SAD" value="3 seats" subtitle="18.38% vote share" color="emerald" />
              <MetricCard title="BJP" value="2 seats" subtitle="8.0% vote share" color="purple" />
            </div>
