  ...
  return (
    <div className="space-y-8">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Poll Projections — 2027 Assembly</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>AAP Critical Vulnerabilities</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Seismic Shift: April 2026 Defection</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Persuadable Voter Types</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Digital Media Usage in Punjab</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="mt-4 overflow-x-auto">
              <DataTable
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Digital Ad Spend Comparison</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="mt-4 overflow-x-auto">
              <DataTable
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Vote Efficiency Analysis</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="mt-4 grid gap-4 md:grid-cols-3">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Key Intelligence Events</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Congress 2027 Math Summary</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
