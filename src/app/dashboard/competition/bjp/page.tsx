...
export default function BJPGrowthPage() {
  return (
    <div className="space-y-8">
      ...
      >
        <MetricCard title="BJP Vote Share" value="18.6%" subtitle="Up from 6.6% in 2022" change={182} trend="up" color="amber" />
        <MetricCard title="BJP Lok Sabha 2024" value="0/13" subtitle="Drew blank despite 18.56% vote share" change={0} trend="neutral" color="amber" />
        <MetricCard title="Mandals Established" value="600+" subtitle="Organizational grid" color="orange" />
        <MetricCard title="Target 2027" value="25-30%" subtitle="Vote share target" color="blue" />
      </motion.div>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>BJP Growth Trajectory — Haryana Model Replication</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>BJP Going Solo 2027 — Confirmed</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>RSS-BJP Organizational Infrastructure</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>BJP IT & Social Media Infrastructure</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="rounded-lg bg-purple-50 p-4 dark:bg-purple-900/20">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Organizational Warfare — Party Infrastructure Comparison</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>BJP&apos;s Delhi Governance Attack on AAP</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="rounded-lg bg-red-50 p-4 dark:bg-red-900/20">
