...
export default function AAPAnalysisPage() {
  return (
    <div className="space-y-8">
      ...
      >
        <MetricCard title="AAP Current Seats" value="92" subtitle="2022 Assembly results" color="orange" />
        <MetricCard title="AAP 2027 Projection" value="58-68" subtitle="Realistic range" trend="down" color="rose" />
        <MetricCard title="Swing Seats" value="25-30" subtitle="High vulnerability" trend="down" color="amber" />
        <MetricCard title="Net Swing Required" value="-24 to -34" subtitle="AAP net seat loss" trend="down" color="rose" />
      </motion.div>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>AAP SWOT Analysis</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Anti-Incumbency Against AAP</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>AAP Promise Tracker — Voter Enticement Analysis</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>AAP Internal Factions & Defection Risk</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>AAP Seat Vulnerability — Top 10 Critical Flips</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>AAP vs BJP Relationship Dynamics</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Vote Bank Transfer Analysis</CardTitle>
          </CardHeader>
          <CardContent>
            <DataTable
