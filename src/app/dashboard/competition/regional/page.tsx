  ...
  return (
    <div className="space-y-8">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Regional Seat Distribution — Malwa vs Majha vs Doaba</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Regional Swing Potential</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Dera/Vote Bank Influence — 40-50 Seats Affected</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>2022 Margin Analysis — Flippable Seats</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="mt-4 grid gap-4 md:grid-cols-3">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Regional Contest Structures</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Urban & Swing Voter Patterns</CardTitle>
          </CardHeader>
          <CardContent>
