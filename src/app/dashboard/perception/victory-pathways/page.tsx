    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        {[
          ...
          <div
            key={pathway.key}
            className={`rounded-xl border-l-4 ${pathway.borderColor} border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800`}
          >
            <div className="flex items-start justify-between">
              ...
              <span
                className={`flex h-8 w-8 items-center justify-center rounded-lg ${pathway.color} text-xs font-bold text-white`}
              >
                  ...
                  <span className="text-slate-500 dark:text-slate-400">
                    ...
                    <span
                      className={`font-semibold ${
                        t.congressSwing > 0 ? "text-green-500" : "text-red-500"
                      }`}
                    >
                      {t.congressSwing > 0 ? "+" : ""}
                      {t.congressSwing} pp
          ...
          {tippingPointVariables.map((v) => (
            ...
            >
              ...
              <div className="mt-2 space-y-1 text-xs text-slate-500 dark:text-slate-400">
                <p>
                  <span className="text-green-500">Pro-Congress:</span>{" "}
                  {v.proCongressShift}
                </p>
                {v.proAapShift !== "—" && (
                  <p>
                    <span className="text-red-400">Pro-AAP:</span>{" "}
                    {v.proAapShift}
                  </p>
                )}
              </div>
