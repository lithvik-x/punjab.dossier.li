/**
 * AC026-Bholath Constituency Dossier Types
...
export interface TownDemographics {
  bhulathTehsil: string;
  scPopulationTehsil: string;
  literacy: string;
}
...
export interface DevelopmentGaps {
  bholathTownInfrastructure: string;
...
export interface KeyLocations {
  ...
  beasRiverArea: string;
  tehsilComplex: string;
}

export interface Infrastructure {
  roads: string;
  riverFlooding: string;
  healthcare: string;
...
// ============================================================================
// LOCAL ISSUES (Bholath Specific)
// ============================================================================

export interface BholathSpecific {
...
export interface AC026BholathTypes {
  // Identity
  ...
  bholathSpecificIssues: BholathSpecific;
