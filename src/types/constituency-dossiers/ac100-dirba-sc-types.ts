/**
 * AC100-Dirba-SC Constituency Dossier Types
...
export interface Ac100DirbaScDossier {
  // Header metadata
...
// Deep dive specific types (from AC100-Dirba-deep.md)
...
export interface ElectionDataPoint {
  winner: string | VerificationStatus;
  party: string | VerificationStatus;
  margin: string | number | VerificationStatus;
...
export interface Ac100DirbaScCombinedData {
  dossier: Ac100DirbaScDossier;
